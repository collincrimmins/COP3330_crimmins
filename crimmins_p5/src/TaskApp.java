...
public class TaskApp {
    ...
    public static void addListItem(TaskList List, String title, String description, String date, boolean complete) throws Exception {
        String Title = "";
        String Description = "";
        String DueDate = "";
        // Input
    ...
    public static void editListItem(TaskList List, int Index, String title, String description, String date, boolean takeInput) {
        int editIndex;
        String Title = "";
        String Description = "";
        String DueDate = "";
        ...
        String[] descriptionRequest;
        String[] duedateRequest;
        if (!title.equals("") || !takeInput) {
            // Predefined
            titleRequest = getTitle(-99, title, false);
        } else {
            titleRequest = getTitle(-99, "", true);
        }
        if (!description.equals("")|| !takeInput) {
            // Predefined
            descriptionRequest = getDescription(-99, description, false);
        } else {
            descriptionRequest = getDescription(-99, "", true);
        }
        if (!date.equals("")|| !takeInput) {
            // Predefined
            duedateRequest = getDueDate(-99, date, false);
        } else {
            duedateRequest = getDueDate(-99, "", true);
